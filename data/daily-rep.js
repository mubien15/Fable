...
export const DAILY_REP_PROGRAM = [
...

  {
    ...
    insight: "Vague feedback creates vague improvement. When you can't name the exact behaviour causing a problem, you're not ready to have the conversation.",
    duration: '8 min',
    type: 'mini',
    mini_scenario: {
      title: 'Name the Issue',
      ...
      challenge: 'Naming the specific behaviour without softening it into meaninglessness or making it personal',
      opening_line: "You said you wanted a quick word? Is everything okay?",
      coaching_focus: [
        'Name the specific behaviour (not "how you come across")',
        'Reference a concrete recent example without making it feel like an ambush',
        'Separate the behaviour from their character — "what you did" not "who you are"',
      ],
      difficulty_default: 'easy',
    },
  },

  {
    ...
    mini_scenario: {
      ...
      opening_line: "Look, I've seen a lot of these analyses. I think you're missing the bigger picture here.",
      coaching_focus: [
...

  {
    ...
    insight: "The conversation you most want to avoid is usually the one you most need to practise.",
    duration: '10–15 min',
    type: 'user-choice',
...

  {
    ...
    insight: "Repetition isn't weakness — it's how something becomes yours. Elite performers practise things they're already good at.",
    duration: '10–15 min',
    type: 'user-choice',
    scenario_id: 'user-choice',
  },
...

  {
    ...
    phase_label: 'Mastery',
    title: 'Your Choice',
    focus: 'Practise the one you need most',
...

  {
    ...
    mini_scenario: {
      ...
      challenge: 'Bringing together everything you have practised: clear opening, specific language, composure under pressure, and a clean close',
