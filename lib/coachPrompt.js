...
export const buildScenarioPrompt = (scenario, difficulty = 'medium', userRole = 'all', voiceMode = false) => {
...
3. ${voiceMode
  ? 'VOICE MODE — keep every counterpart response to 1 short sentence only. The user is speaking and listening in real time; long responses break the rhythm. No action cues like *sighs* or *crosses arms*.'
  : 'Keep every counterpart response to 1–3 sentences. No coaching, no meta-commentary while in character.'}
